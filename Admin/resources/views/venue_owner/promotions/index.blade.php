        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('owner.promotions.create') }}" class="btn btn-primary">
                        ...
                        <table class="table table-hover table-bordered align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        @if($promotion->venue)
                                            <span class="badge bg-info">{{ $promotion->venue->name }}</span>
                                        @else
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('owner.promotions.show', $promotion) }}"
                                                class="btn btn-outline-primary btn-sm me-2" title="Xem chi tiết">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('owner.promotions.edit', $promotion) }}"
                                                class="btn btn-outline-warning btn-sm me-2" title="Sửa">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form method="POST" action="{{ route('owner.promotions.destroy', $promotion) }}"
                                                class="d-inline"
