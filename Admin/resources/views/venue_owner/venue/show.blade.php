                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        @if ($venue->images->count())
                            ...
                            {{-- Hiển thị Ảnh chính --}}
                            @if ($primaryImage)
                                <div class="mb-3 position-relative text-center bg-light rounded">
                                    <img src="{{ asset('storage/' . str_replace(url('/'), '', $primaryImage->url)) }}"
                            ...
                            <div class="row g-2">
                                @foreach ($venue->images as $image)
                                    @if ($primaryImage && $image->id == $primaryImage->id)
                                        @continue
                                    @endif

                                    <div class="col-4">
                                        <img src="{{ asset('storage/' . str_replace(url('/'), '', $image->url)) }}"
