...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('admin.flash_sale_campaigns.create') }}" class="btn btn-primary shadow-sm">
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="card h-100 border-0 shadow-sm campaign-card position-relative">
                        ...
                        <div
                            ...
                            <div class="btn-group">
                                {{-- Nút Xem/Sửa --}}
                                <a href="{{-- route('flash_sale_campaigns.edit', $campaign->id) --}}" class="btn btn-sm btn-outline-secondary" title="Chỉnh sửa">
                                    <i class="bi bi-pencil-square"></i>
                                </a>

                                {{-- Nút Xóa (Dùng Form để an toàn bảo mật) --}}
                                <form action="{{-- route('flash_sale_campaigns.destroy', $campaign->id) --}}" method="POST" class="d-inline"
