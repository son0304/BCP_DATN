            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0 text-primary font-weight-bold">Chỉnh sửa Sản phẩm</h4>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('owner.products.update', $product) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('venue_id') is-invalid @enderror"
                                        ...
                                        <option value="{{ $venue->id }}" {{ old('venue_id', $product->venue_id) == $venue->id ? 'selected' : '' }}>
                                            {{ $venue->name }}
                                        </option>
                                        @endforeach
                                    </select>
