            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('owner.promotions.index') }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($promotion->venue)
                                            <span class="badge bg-info fs-6">{{ $promotion->venue->name }}</span>
                                        @else
                    ...
                    <div class="mt-4 text-center">
                        <a href="{{ route('owner.promotions.edit', $promotion) }}" class="btn btn-warning">
