      ...
      <div className="lg:w-3/5 space-y-4">
        ...
        >
          ...
          <div className="absolute bottom-6 left-6 right-6 text-white">
            <h1 className="text-2xl md:text-3xl font-extrabold leading-tight">{venue.name}</h1>
            <div className="mt-2 flex flex-wrap gap-4 text-sm opacity-95">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-200">
                  {venue.address_detail + '-' + district?.data.name + '-' + province?.data.name ?? 'Địa chỉ đang cập nhật'}
                </span>
              </div>
            </div>
          </div>
      ...
      <div className="lg:w-2/5 p-6 bg-white rounded-2xl shadow-md border border-gray-200 flex flex-col gap-6">
        ...
        <div className="space-y-4 text-base text-[#4B5563]">
          <div>
            ...
            <span>
              Chủ sân: <span className="font-bold text-[#F59E0B]">{owner?.data.name ?? '—'}</span>
            </span>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="pt-2">
            <p className="font-semibold text-[#11182C] mb-1 text-base">Vị trí trên Bản đồ</p>
