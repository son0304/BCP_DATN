...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('users.create', compact('roles', 'provinces', 'districts'));
    }
    ...
    public function show(User $user)
    {
        ...
        return view('users.show', compact('user', 'bookings', 'venues', 'roles'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('users.edit', compact('user', 'roles', 'provinces', 'districts'));
    }
