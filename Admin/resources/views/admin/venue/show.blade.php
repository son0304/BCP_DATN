                ...
                <div class="card-body">
                    ...
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8 font-monospace text-danger fw-bold">
                            {{ $merchant_profile['bank_account_number'] ?? 'N/A' }}
                        </dd>

                        <dt class="col-sm-4 text-muted">Chủ tài khoản:</dt>
                        <dd class="col-sm-8 text-uppercase">
                            {{ $merchant_profile['bank_account_name'] ?? 'N/A' }}
                        </dd>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-success fw-bold">
                                        @php
                                        $prices = $court->availabilities->pluck('price')->unique()->sort()->values();
                                        $display = $prices->map(function($price) {
                                    ...
                                    <td class="text-center">
                                        @if ($court->is_indoor)
                                        <span
                                            class="badge bg-info bg-opacity-10 border border-info">Trong
                                            nhà</span>
                                        @else
                                        <span
                                            class="badge bg-warning bg-opacity-10 border border-warning">Ngoài
                                            trời</span>
                                        @endif
                                    </td>
