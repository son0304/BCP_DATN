...
class CourtController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('courts.index')->with('success', 'Thêm sân và tạo lịch hoạt động thành công!');
        } catch (\Exception $e) {
            DB::rollBack();
            return redirect()->back()->withInput()->with('error', 'Đã có lỗi xảy ra. Vui lòng thử lại.');
        }
    }
    ...
    public function update(Request $request, Court $court)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('courts.index')->with('success', 'Cập nhật sân và lịch hoạt động thành công!');
        } catch (\Exception $e) {
            DB::rollBack();
