        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('owner.promotions.update', $promotion) }}">
                        @csrf
                        @method('PUT')

                        <div class="row">
                            {{-- Venue (Read-only cho Owner) --}}
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="venue_id" class="form-label fw-bold">Venue</label>
                                    <input type="text"
                                        class="form-control"
                                        value="{{ $promotion->venue ? $promotion->venue->name : 'N/A' }}"
                                        readonly
                                        style="background-color: #e9ecef;">
                                    <input type="hidden" name="venue_id" value="{{ $promotion->venue_id }}">
                                    <small class="form-text text-muted">Owner không thể thay đổi venue của voucher</small>
                                </div>
                            </div>
