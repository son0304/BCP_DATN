        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('owner.product_categories.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="p-3 mb-4 rounded-3" style="background-color: #f8f9fa;">
                        <form method="GET" action="{{ route('owner.product_categories.index') }}">
                            <div class="row g-3">
                                <!-- Search -->
                                <div class="col-md-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('owner.product_categories.show', $category) }}"
                                                class="btn btn-outline-primary btn-sm me-2" title="Xem chi tiết">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('owner.product_categories.edit', $category) }}"
                                                class="btn btn-outline-warning btn-sm me-2" title="Sửa">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form method="POST" action="{{ route('owner.product_categories.destroy', $category) }}"
                                                class="d-inline"
